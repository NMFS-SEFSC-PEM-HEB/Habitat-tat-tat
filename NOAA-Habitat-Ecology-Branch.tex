...
\hypersetup{
  pdftitle={NOAA Habitat Ecology Branch},
  pdfauthor={Joy Merino},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{NOAA Habitat Ecology Branch}
\author{Joy Merino}
\date{}
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, frame hidden, interior hidden, sharp corners, breakable]}{\end{tcolorbox}}\fi
